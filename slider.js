...
Slider.prototype.mouseMove = function(pos) {
	var diff;
	if(this.active) {
		diff = pos.x - this.mouseDownPos.x;
...
Slider.prototype.render = function() {
	...
	ctx.drawImage(tl.sliderLeft, this.startx, top);
	ctx.drawImage(tl.sliderMid, this.startx + tl.sliderHandleWidth, top, this.width - 2*tl.sliderHandleWidth, tl.sliderHeight);
	ctx.drawImage(tl.sliderRight, this.endx - tl.sliderHandleWidth, top);
};